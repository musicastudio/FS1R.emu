...
|---|---|
| 0x230091 | 1152 preset voices (banks **PrC-PrK**) stored as DX7 VCED voices, 155 bytes each. The firmware converts them with its DX7 -> FS1R conversion at load time |
