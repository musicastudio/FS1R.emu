...
COMPLETED. The skirt, the noise formant's bandwidth law, what separates each pair, and all1/all2's geometry were closed on 2026-09-19, 2026-09-21 and 2026-09-24; [skirt.md](skirt.md), [noise.md](noise.md) and `docs/findings.md` carry the working.
