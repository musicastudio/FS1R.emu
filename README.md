...
- `plugin/` the JUCE layer: the panel and its artwork `fs1r_panel.svg`, the editor pages, the patch manager, and `parameterDescriptions_fs1r.json` generated by `tools/gen_parameters.py`
